namespace TestSuite.UnitTests
{
    ...
    public class StringProcessorJobTests
    {
        ...
        private readonly Mock<ICharacterNotifications> processorNotificationyMock = new();
        ...
        public async Task ExecuteAsync_WhenGivenValidUserId_ShouldProcessSavedRequestAndSendNotifications()
        {
            ...
            processorNotificationyMock.Setup(p => p.SendCharactersToClient(It.IsAny<string>(), userId,
            ...
            // Assert
            processorNotificationyMock.Verify(p => p.SendCharactersToClient(It.IsAny<string>(), userId,
        ...
        public async Task ExecuteAsync_WhenOperationIsCancelled_ShouldStopProcessingAndSendProcessingCancelledNotification()
        {
            ...
            processorNotificationyMock.Setup(p => p.SendCharactersToClient(It.IsAny<string>(), userId, request,
