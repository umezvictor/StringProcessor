...
{
    public class StringProcessorJob(ICharacterNotifications characterNotifications, IStringProcessor stringProcessor,
        ...
        public async Task ExecuteAsync(string userId, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (request != null)
                {
                    ...
                    {
                        await characterNotifications.SendCharactersToClient(processedString, userId, request, cancellationToken);
